                            ...
                            {params.id && (
                                <>
                                    <div className="client-button">
                                        <Button variant="contained" fullWidth onClick={() => navigate("/sign/" + params.id)}>
                                            {clientName || <MuiLoading size={"1.5rem"} />}
                                        </Button>
                                        {login && (
                                            <div className="or">
                                                <div>
                                    ...
                                    <UpArrowIcon
                                        ...
                                        className="up-arrow"
                                        style={{ transform: login && "rotate(180deg)" }}
                                    />
                                </>
                            )}
                            {login && (
                                    ...
                                    <div className="bottom-container">
                                        <div className="remember-wrapper">
                                            <div className="remember-container">
                                                <FormControlLabel
                                                    control={
                                                        <Checkbox checked={remind} onChange={() => setRemind(!remind)} />
                                                    }
                                                    label={"Lembre de mim"}
                                                />
                                            </div>

        ...
        <div className='ContatoFinanceiro-Component' >
            ...
            <Formik initialValues={initialValues} onSubmit={nextStage} >
                ...
                <Form onKeyDown={(event) => {
                    ...
                    <InputField title={'Responsável Financeiro'} id='name' value={values.name} handleChange={handleChange} />
                    <InputField title={'Telefone Financeiro'} inputMode={'tel'} mask={["(", /\d/, /\d/, ")", " ", /\d/, /\d/, /\d/, /\d/, /\d/, "-", /\d/, /\d/, /\d/, /\d/]} id='phone' value={values.phone} handleChange={handleChange} />
                    <InputField title={'E-mail do responsável financeiro'} id='email' value={values.email} handleChange={handleChange} />
                    <NavButtons goBack={(event) => goBack(event)} nextStage={(event) => {
                        event.preventDefault()
                        submitForm()

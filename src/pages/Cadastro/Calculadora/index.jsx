...
export const Calculadora = ({}) => {
            ...
            <div className="flag-container">
                ...
                <div className="yearly">
                    ...
                    <CurrencyFormat
                        ...
                        prefix={"R$ "}
                        style={{ fontSize: isMobile ? "5vw" : "1.5vw", fontWeight: "bold", color: COLORS.primary }}
                    />
                </div>
                <hr />
                <div className="monthly">
                    ...
                    <CurrencyFormat
                        ...
                        fixedDecimalScale={true}
                        prefix={"R$ "}
                        style={{ color: COLORS.primary, whiteSpace: "nowrap" }}
                    />
                </div>
            </div>
        )
    ...
    const toSite = () => {
        window.location.href = "https://cooperativasion.com.br"
    }
    ...
    return (
        <div className="Calculadora-Component">
            ...
            <NavButtons goBack={toSite} nextStage={nextStage} disabledNext={!validUnit} />
        </div>
    )
}